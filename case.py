...
for car in base_result:
    ...
    print('Автомат №1  максимальная очередь: 3 Марки бензина: АИ-80 ->' + '*'*len(a1))
    print('Автомат №2  максимальная очередь: 2 Марки бензина: АИ-92 ->' + '*'*len(a2))
    print('Автомат №3  максимальная очередь: 4 Марки бензина: АИ-92 АИ-95 АИ-98 ->' + '*'*len(a3))
